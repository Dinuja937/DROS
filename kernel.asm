; ==================================================================
; DROS -- A simple Operating System kernel created by Dinuja Ranaweera
; This OS is inspired by MikeOS and built for learning and exploration.
; ==================================================================

    BITS 16                  ; This is a 16-bit program
    ORG 0000h                ; Starting memory address set by the bootloader
...
start:
    ...
    call clear_screen       ; Clear screen before displaying anything
...
main_loop:
    ...
    call read_string        ; Get user input
    ...
    ; If the command doesn't match, show unknown command message
...
; ==================================================================
; Utility Subroutines for Screen and Input
; ==================================================================
...
; ==================================================================
; Static Data (Messages and Labels)
; ==================================================================

welcome_string      db 'Welcome to DROS created by Dinuja Ranaweera!', 0
prompt_string       db 'DROS :) >> ', 0
...
about_text      db 'Author: Dinuja Ranaweera', 0
version_text    db 'DROS Version 1.0', 0
reboot_text     db 'System will reboot now...', 0
echo_response   db 'Echo: ', 0
